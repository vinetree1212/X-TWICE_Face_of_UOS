...
#get image list
image_path = '/home/artia/prj/datasets/preprocessed_coco/edge_detected_without_bg'
image_list = os.listdir(image_path)

# define annotstions list 
annotations_path = '/home/artia/prj/datasets/preprocessed_coco/edge_detected_without_bg'
...
print(i)
#########print(new_dict)
with open('processed_person_keypoints_train2017.json', 'w') as outfile:
